...
export function RebuildIndexField(): ReactElement {
  ...
  return (
    <SettingsField
      legend={t('settings.searchSection.rebuild.legend')}
      description={t('settings.searchSection.rebuild.description')}
    >
      <div className="mt-3 flex justify-start">
        ...
        >
          {rebuilding
            ? t('settings.searchSection.rebuild.rebuilding')
            : t('settings.searchSection.rebuild.button')}
        </Button>
      </div>
    </SettingsField>
  )
