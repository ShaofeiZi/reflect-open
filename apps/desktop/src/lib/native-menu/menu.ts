  ...
  return [
    {
      ...
      entries: [
        ...
        separator(),
        predefined('Services', translate('menu.services')),
        separator(),
        predefined('Hide', translate('menu.hide-app')),
        predefined('HideOthers', translate('menu.hide-others')),
        predefined('ShowAll', translate('menu.show-all')),
        separator(),
    ...
    },
    {
      ...
      entries: [
        ...
        separator(),
        predefined('CloseWindow', translate('menu.close-window')),
      ],
    },
    {
      text: translate('menu.edit'),
      entries: [
        predefined('Undo', translate('menu.undo')),
        predefined('Redo', translate('menu.redo')),
        separator(),
        predefined('Cut', translate('menu.cut')),
        predefined('Copy', translate('menu.copy')),
        predefined('Paste', translate('menu.paste')),
        predefined('SelectAll', translate('menu.select-all')),
      ],
    },
    {
    ...
    },
    {
      ...
      entries: [
        ...
        separator(),
        predefined('Minimize', translate('menu.minimize')),
        predefined('Maximize', translate('menu.zoom')),
        separator(),
        predefined('BringAllToFront', translate('menu.bring-all-to-front')),
      ],
    },
    {
